...
public class Start {
    ...
    private void run() throws NamingException, IOException {
        ...
        new Resource("notice/viewer/datasource", dataSource);

        new EnvEntry("notice/viewer/analyzing", Boolean.FALSE, true);
        new EnvEntry("notice/viewer/password", "password", true);
