...
public class NoticeViewerProject extends ProjectModule {
    @Override
    public void build(Builder builder) {
        builder
            .cookbook(JavaProject.class)
                .produces(new Artifact("com.goodworkalan/notice-viewer/0.1"))
                .main()
                    .depends()
                        .artifact(new Artifact("com.goodworkalan/notice-json/0.1"))
                        .artifact(new Artifact("com.goodworkalan/paste/0.2.1"))
