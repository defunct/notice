...
public class NamedValues {
     ...
     */
    public static final String JNDI_ANALYZING_NAME = "java:comp/env/notice/viewer/analyzing";

    /** A single password to protect the viewer. */
    public static final String JNDI_PASSWORD_NAME = "java:comp/env/notice/viewer/password";
